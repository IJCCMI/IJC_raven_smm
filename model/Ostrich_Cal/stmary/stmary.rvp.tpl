...
:SoilParameterList
  :Parameters,        POROSITY,        HBV_BETA,  PET_CORRECTION,  FIELD_CAPACITY,        SAT_WILT, MAX_CAP_RISE_RATE,   MAX_PERC_RATE,  BASEFLOW_COEFF,      BASEFLOW_N, BASEFLOW_COEFF2, STORAGE_THRESHOLD, 
    ...
    [DEFAULT],             0.4,         par_x08,         par_x11,         par_x14,         par_x17,         par_x20,         par_x21,         par_x22,         par_x26,         par_x27,         50, 
    ...
    TOPSOIL3,         _DEFAULT,         par_x10,         par_x13,         par_x16,         par_x19,        _DEFAULT,        _DEFAULT,         par_x25,        _DEFAULT,         par_x29,         _DEFAULT, 
    FAST_RES3,        _DEFAULT,         par_x10,         par_x13,         par_x16,         par_x19,        _DEFAULT,        _DEFAULT,         par_x25,        _DEFAULT,         par_x29,         _DEFAULT, 
    SLOW_RES3,        _DEFAULT,         par_x10,         par_x13,         par_x16,         par_x19,        _DEFAULT,        _DEFAULT,         par_x25,        _DEFAULT,         par_x29,         _DEFAULT, 
...
:LandUseParameterList
  :Parameters,     MELT_FACTOR,    DD_MELT_TEMP, MIN_MELT_FACTOR, HBV_MELT_ASP_CORR, HBV_MELT_FOR_CORR, REFREEZE_FACTOR, FOREST_SPARSENESS, HBV_MELT_GLACIER_CORR, HBV_GLACIER_KMIN, GLAC_STORAGE_COEFF,  HBV_GLACIER_AG,   LAKE_PET_CORR,	OW_PET_CORR,	LAKE_REL_COEFF,    PDMROF_B,       DEP_MAX, MAX_DEP_AREA_FRAC, PONDED_EXP, 
    ...
    [DEFAULT],         par_x32,         par_x36,               2,                 0,                 1,         par_x38,               0.5,        	  par_x39,            0.001,         	par_x40,               0,         par_x63,          par_x64,		  0.01,           1.0,       250,           0.4,          3, 
